...
declare namespace modlib {
  ...
  export function getHQCondition(obj: mod.HQ, n: number): ConditionState;
  export function getSectorCondition(obj: mod.Sector, n: number): ConditionState;
  export function getVehicleSpawnerCondition(obj: mod.VehicleSpawner, n: number): ConditionState;
  export function getGlobalCondition(n: number): ConditionState;
  export function getSimpleCondition(): SimpleConditionState;
  export function getPlayersInTeam(teamObj: mod.Team): any[];
  export function ParseUI(...params: any[]): any;
